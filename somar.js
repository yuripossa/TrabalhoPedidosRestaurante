...
function calculartudo() {
	...
	var total = parseFloat(v1*10)+parseFloat(v2*12)+parseFloat(v3*16)+parseFloat(v4*32)+parseFloat(v5*52)+parseFloat(v6*40)+parseFloat(v7*10)+parseFloat(v8*16)+parseFloat(v9*20);
	var preco = "R$"+total;
